...
Sample_R=0.005;
Reference_R=0.001:0.00025:0.05;
...
BS_Ratio_Target=(1-Target_Power_on_Sample/Sample_SinglePass_CE/SLD_Power);
...
for r=1:length(BS_Ratio)
    for q=1:length(Reference_R)
        Reference_Power(q,r)=SLD_Power*BS_Ratio(r)*(1-BS_Ratio(r))*(Reference_SinglePass_CE^2)*Reference_R(q);
        Ratio_R=BS_Ratio(r)*(1-BS_Ratio(r))*(Reference_SinglePass_CE^2)*Reference_R(q);

        Sample_Power(q,r)=SLD_Power*(1-BS_Ratio(r))*BS_Ratio(r)*(Sample_SinglePass_CE^2)*Sample_R;
        Ratio_S=(1-BS_Ratio(r))*BS_Ratio(r)*(Sample_SinglePass_CE^2)*Sample_R;

        Sample_Power_at_Sample=SLD_Power.*(1-BS_Ratio(r)).*Sample_SinglePass_CE;
