clear all
%%
Folder_Path='C:\TuanShu\180118_Histogram Analysis\with or without blue ink around\';
Center=[500 600];
Half_Width=100;
...
for p=1:Length_file_list
    ...
    xlim([0 255]);
    saveas(gcf,[Data_Save_Folder '\' File_list(p).name sprintf('_X%g_Y%g',Center(2),Center(1)) '_Histogram_R.png']);
    hold on
