...
If_Save_Raw3D=0;
If_Reverse=1;
File_Reading_Range=[7000 7500]; %9000附近為glass, [7500 8000] DEJ
...
%% hsv to rgb
    ...
    imwrite(RGB_Image,[Data_Save_Folder sprintf('%s_Corrected_Start%g_End%g_Color.tif',folder_list(QQQ).name,Start_Frame,End_Frame)],'tiff');
