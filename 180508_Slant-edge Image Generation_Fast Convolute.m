...
imwrite(Edge_Blur,[Data_Save_Folder sprintf('Simulated Slant-Edge_A%g_SR%g_R%g_Raw_%s.tif',Edge_Angle,Optical_SR,Optical_Resolution_LSF,Convolution_Method)]);
