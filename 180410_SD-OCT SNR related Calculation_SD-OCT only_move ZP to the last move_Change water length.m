...
Thickness_List=[5 14.93 0.6+3+4+22.615];%+17.2];% 0 0];%[0.6+3+4+17.2 14.93 5 0 0];%[0.6+3+4+17.2 14.93 5 3.42 0];    %array, mm, single-trip thickness
