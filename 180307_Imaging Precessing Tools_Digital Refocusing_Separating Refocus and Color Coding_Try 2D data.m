...
%% Median along Y
    ...
    Image_Stack_Abs_FFTY=fft(abs(Image_Stack_Complex),[],2);
    ...
    subplot(2,1,1)
    imagesc(TSAutoBrightness(imgaussfilt(squeeze(TSBinning(abs(Image_Stack_Abs_FFTY(:,FFTY_Bin,Z_ROI_FFTY(1):Z_ROI_FFTY(2)))./abs(Image_Stack_Abs_FFTY(:,1,Z_ROI_FFTY(1):Z_ROI_FFTY(2))),3,16)),Sigma)',ABTH,CTH))
    axis off
    %subplot(3,1,2)
    %imagesc(TSAutoBrightness(medfilt2(squeeze(TSBinning(abs(Image_Stack_Abs_FFTY(:,FFTY_Bin,Z_ROI_FFTY(1):Z_ROI_FFTY(2)))./abs(Image_Stack_Abs_FFTY(:,1,Z_ROI_FFTY(1):Z_ROI_FFTY(2))),3,16)),[Filter_Size Filter_Size])',ABTH,CTH))
    %axis off
