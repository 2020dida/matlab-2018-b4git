...
%% LSF related
Resolution_LSF=0.595;     %micron
LSF_Type='Airy';    %'Gaussian' 'Airy'
%% Input Signal Related
Spatial_Period=0.5;%2;            a           %micronaa
...
F=0:Spatial_Frequency_SR:(Max_Spatial_Frequency-Spatial_Frequency_SR);
switch MTF_Type
    case 'LSFbased'
...
if If_Plot_MTF == 1
    ...
    dlmwrite([Data_Save_Folder '\MTF.txt'],[F' MTF],'delimiter','\t','newline','pc','precision', '%.6f');
end
