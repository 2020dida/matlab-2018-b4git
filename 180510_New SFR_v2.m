...
%%
Image_Path='C:\TuanShu\180510_SFR for standard image\Simulated Slant-Edge_A95_SR0.45_R0.5_XFOV20_YFOV20.tif';
...
if Known_Angle >0
    ...
    Y_ROI=[(Y_ROI_Start+Required_Line_to_Comp_NCycle-1):(-1):Y_ROI_Start];
end
