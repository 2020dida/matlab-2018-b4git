...
ZP_Ratio=8;
Original_Frequency_Resolution_Ratio=8;
...
RI=TSRI(Wavelength_Array,'Silica')
subplot(1,1,1)
...
Thickness_List=[0.6+3+4+17.2 14.93 4.7 3.7 0];    %array, mm, single-trip thickness
...
Thickness_Tol=20000;   %micron, +/-
delta_Thickness=5000;
