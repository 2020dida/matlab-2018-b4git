...
DCPhase_UnityLength_2d=diff(TSRI(Wavelength_Array,DC_Material)./Wavelength_Array*2*pi*2,2); %Unity for ROUNDTRIP!!
...
DC_Thickness_Est=DCPhase_UnityLength_2d'\Phase_Spectrum_Modi_2d';

%%
Coef=1;
subplot(1,1,1)
plot(Frequency_Array(3:end),Phase_Spectrum_Modi_2d,Frequency_Array(3:end),DCPhase_UnityLength_2d*DC_Thickness_Est*Coef);
xlabel('Optical Frequency (THz)');
ylabel('2nd Derivative of Phase (vs Frequency)');
